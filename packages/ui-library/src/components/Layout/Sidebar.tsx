...
/**
 * Sidebar types kept tiny and purpose-built for the VDS accordion markup you’re using.
 */
...
/**
 * VDS accordion side nav — props-driven but preserves your exact class names.
