...
type BaseProps = {
  ...
  /** Matches VDS modifier classes on qld__accordion-group */
   ...
   * VDS generally allows multiple open, so default is true.
   */
  allowMultipleOpen?: boolean;

  /** Heading level for titles (VDS examples use h2) */
